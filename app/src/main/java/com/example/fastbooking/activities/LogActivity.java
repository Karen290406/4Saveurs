...
import com.example.fastbooking.admin.AdminMainActivity;
        ...
        btn_sign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etUsername.getText().toString().length() == 0 || etPassword.getText().toString().length() == 0){
                    Toast.makeText(LogActivity.this, "Enter Username and Password", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (etUsername.getText().toString().equals("admin") && etPassword.getText().toString().equals("admin")) {
                        startActivity(new Intent(LogActivity.this, AdminMainActivity.class));
                    } else {
