    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(etUsername.getText().toString().length() == 0 || etPassword.getText().toString().length() == 0 || etConfirmPassword.getText().toString().length() == 0){
                    Toast.makeText(RegActivity.this, "Enter Username and Password", Toast.LENGTH_SHORT).show();
                } else {
                    if (etConfirmPassword.getText().toString().equals(etPassword.getText().toString())) {
                        ...
                        table_user.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.child(etUsername.getText().toString()).exists()) {
                                    ...
                                    mDialog.dismiss();
                                    User user = new User(etUsername.getText().toString(), etPassword.getText().toString(), false);
                        ...
                        Toast.makeText(RegActivity.this, "Different Passwords", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
